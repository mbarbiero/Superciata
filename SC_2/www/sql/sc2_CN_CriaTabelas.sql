CREATE TABLE IF NOT EXISTS sc2_CN_PONTOS (
...
CREATE TABLE IF NOT EXISTS sc2_CN_PONTOS_UNICOS (
	COD_MUNICIPIO        VARCHAR(7),
	COD_UNICO_ENDERECO   VARCHAR(20),
...
CREATE TABLE IF NOT EXISTS sc2_CN_LOGRADOUROS (
	COD_MUNICIPIO        VARCHAR(7),
	NOM_LOGRADOURO       VARCHAR(250),
...
CREATE TABLE IF NOT EXISTS sc2_CN_FACES (
	ID_FACE           VARCHAR(22),
	COD_MUNICIPIO     VARCHAR(7),
	ID_QUADRA         VARCHAR(19),
	NOM_LOGRADOURO    VARCHAR(250),
...
CREATE TABLE IF NOT EXISTS sc2_CN_QUADRAS (
